//! Base Widget Traits for MoFA UI
//!
//! This module defines common traits that mofa-ui widgets implement
...
//! | Trait | Purpose |
//! |-------|---------|
//! | `MofaWidget` | Base trait for all mofa-ui widgets |
...
//!
//! ```rust,ignore
//! use mofa_ui::traits::{MofaWidget, Themeable, Clearable};
//!
//! impl MofaWidget for ChatPanel {
