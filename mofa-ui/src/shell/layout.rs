...
live_design! {
    ...
    /// MoFA Shell - Main application layout
...
/// Actions emitted by MofaShell
#[derive(Clone, Debug, DefaultNone)]
pub enum MofaShellAction {
    None,
}

#[derive(Live, LiveHook, Widget)]
pub struct MofaShell {
    #[deref]
    view: View,
